...
# find $target_dir | grep '.go$' | xargs -I{} sed -r -i "" "s|yunion.io/x/onecloud/pkg/cloudprovider|github.com/Havens-blog/cloudmux/pkg/cloudprovider|g" {}

    # s|yunion.io/x/onecloud/pkg/apis|github.com/Havens-blog/cloudmux/pkg/apis|g; \

find $target_dir | grep '.go$' | xargs -I{} sed -r -i "" "s|multicloud.ApsaraTags|ApsaraTags|g; \
    s|yunion.io/x/onecloud/pkg/cloudprovider|github.com/Havens-blog/cloudmux/pkg/cloudprovider|g; \
    s|yunion.io/x/onecloud/pkg/multicloud|github.com/Havens-blog/cloudmux/pkg/multicloud|g; \
